...
<?php $__env->startSection('title', 'Dashboard - CuentasCobro'); ?>
                    ...
                    <div class="col-md-3 mb-3">
                        <div class="card border-0 shadow-sm h-100">
                            <div class="card-body text-center">
                                <div class="text-center mb-2" style="color: var(--uc-verde);">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-4 mb-3">
                                        <a href="#" class="btn btn-lg w-100" style="background: var(--uc-verde); color: var(--uc-blanco); border: none;">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp2\htdocs\CuentaCobros\CuentasCobro\resources\views/dashboard.blade.php ENDPATH**/ ?>